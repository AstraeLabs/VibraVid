...
class GetContentInfo:
    """Fetch content metadata (movie or series) from Disney+."""
...
class GetPageInfo:
    """Fetch page info for a Disney+ title."""
    ...
    def _fetch(self):
        try:
            ...
            params = {"limit": "999"}
            resp = self.client._request("GET", endpoint, params=params)
...
class GetSerieInfo:
    """Scrape series info with seasons and episodes from Disney+."""
