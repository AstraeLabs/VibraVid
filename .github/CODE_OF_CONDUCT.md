...
issues, pull requests and discussions, and the project's Discord server), and
...
project's [Discord server](https://discord.com/invite/8vV68UGRc7) (DM a
moderator) or by opening a private [GitHub security advisory](https://github.com/AstraeLabs/VibraVid/security/advisories/new)
